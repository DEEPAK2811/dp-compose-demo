...
import com.example.dp_compose_demo.R
...
@Composable
fun ImageRow(details: MovieDetails) {
...
@Composable
fun Rating(details: MovieDetails, modifier: Modifier) {
...
@Composable
fun ForegroundPoster(details: MovieDetails) {
...
@Composable
fun BackGroundPoster(details: MovieDetails) {
    Box(
        modifier = Modifier
            .fillMaxSize()
